...
class CI_Email {
	...
	var	$smtp_host		= "ssl://smtp.wynahealth.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "mailer@wynahealth.com";		// SMTP Username
	var	$smtp_pass		= "mailWyn4.";		// SMTP Password
	var	$smtp_port		= "465";		// SMTP Port*/
	var	$protocol		= "smtp";
	var	$smtp_host		= "mail.wynacom.com";
	var	$smtp_user		= "amirul@wynacom.com";
	var	$smtp_pass		= "generally";
	var	$smtp_port		= "587";
